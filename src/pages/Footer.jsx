...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="bg-white text-gray-900 shadow-lg border-t border-blue-100 w-full"
    >
      <div className="py-10 px-4 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="flex flex-col items-start">
            ...
            <h2 className="text-2xl font-extrabold mb-2">
              Anthem <span className="text-blue-600">Fans</span>
            </h2>
            <p className="text-gray-500">Just Play Your Anthem.</p>
          </div>
        ...
        <div className="text-center text-sm text-gray-500 pt-8 border-t border-blue-100 mt-10">
          © {new Date().getFullYear()}{" "}
          <span className="text-blue-700 font-semibold">Anthem Fans</span>. All rights reserved.
        </div>
      </div>
    </motion.footer>
  );
